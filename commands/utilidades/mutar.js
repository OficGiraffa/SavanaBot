...
if(muterole === null) return message.reply(`:x: antes de usar esse comando você precisa configurar um cargo para dar pra pessoa, **Para isso use o comando:  ${prefix}muterole <@cargomute>**`)
