...
module.exports.run = async (client, message, args) =>{
     if(!message.member.hasPermission("MANAGE_ROLES")) return message.reply("Me parece que você não tem permissão 🤔");
    ...
    if(args[0] === "del") {
    if(rolemute === null) return message.reply("não há nenhum cargo definido nesse servidor pra eu tirar 🤔")
